...
/*Esta é nossa classe / Objeto que representa o aluno*/
	public class Aluno extends Pessoa {
		...
		/*Set é pra Adicionar ou receber dados para os atributos*/
		/*Get é pra resgatar ou obter o valor do atributo*/
	...
	public String msgMaiorIdade() {
			return this.pessoaMaiorIdade() ? "Oba! Aluno maior idade" : "Ixi vc é e menor de idade";
	}
